...
const char *bsec_conf_path = "bsec_v2-5-0-2/config/bme688bme688_sel_33v_3s_4d/bsec_selectivity.config";
FILE *bsec_conf;
#endif
...
static PyObject *bme_get_sensor_id(BMEObject *self)
{
    ...
    uint32_t uid;
    int8_t rslt;
    rslt = bme68x_get_regs(BME68X_REG_UNIQUE_ID, (uint8_t *) &id_regs, len, &(self->bme));
    if (rslt < BME68X_OK)
    {
